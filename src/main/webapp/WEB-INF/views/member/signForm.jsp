           ...
           <div class="accounts_forms signup_form w-100 h-100" id="signup">
             ...
             <form method="post" name="form" class="form w-100 p-4" action="signUp.do" id="form">
               <div class="row">
                 <div class="col col-sm-12 col-md-12 col-lg-6 m-0">
                   <div class="form-group">
                     ...
                     <input type="text" name="userName" class="form-control" id="userId" onfocus="labelUp(this)" onblur="labelDown(this)" required />
                   </div>
                 </div>
                 <div class="col col-sm-12 col-md-12 col-lg-6 m-0">
                   <div class="form-group">
                     <label for="lname">휴대폰번호</label>
                     <input type="text" name="phone" class="form-control" id="password" onfocus="labelUp(this)" onblur="labelDown(this)" required />
                   </div>
                 </div>
               </div>
               <!--form-row-->
               <div class="form-group">
                 ...
                 <input type="userId" name="userId" class="form-control" id="userId" onfocus="labelUp(this)" onblur="labelDown(this)" required />
               </div>
               <div class="form-group">
               ...
               <div class="form-group">
                 ...
                 <input type="text" name="address" class="form-control" id="address" onfocus="labelUp(this)" onblur="labelDown(this)" required />
               </div>
               <div class="form-group">
